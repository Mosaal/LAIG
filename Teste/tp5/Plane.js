...
function Plane(scene, nrDivs,horizontal,vertical) {
	CGFobject.call(this,scene);

	// nrDivs = 1 if not provided
	nrDivs = typeof nrDivs !== 'undefined' ? nrDivs : 1;
	vertical = typeof vertical !== 'undefined' ? vertical : 1;
	horizontal = typeof horizontal !== 'undefined' ? horizontal : 1;
...
Plane.prototype.initBuffers = function() {
	...
	*/
	...
	{
		this.auxx=((this.horizontal-this.vertical)/2)/this.horizontal;
	}
	else
	{
		this.auxy=((this.vertical-this.horizontal)/2)/this.vertical;
	}
